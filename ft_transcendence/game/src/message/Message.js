...
Message.authenticationMessageTypeRequest = new Map([
    ['AUTHENTICATION_LOGIN', 'AUTHENTICATION_LOGIN'],
    ['AUTHENTICATION_LOGOUT', 'AUTHENTICATION_LOGOUT']
]);
Message.gameMessageTypeRequest = new Map([
...
Message.tournamentMessageTypeResponse = new Map([
...
Message.messageTypeResponse = new Map([
