...
async function updateUserProfile(userId, body) {
  //console.logog("Atualizando perfil:", userId);

  //console.logog("🚨 Dados recebidos no body:", body);
  ...
  if (body.avatar && body.avatar.filename) {
    ...
    try {
      ...
      //console.logog("Temp removido:", tempFilePath);
    } catch (err) {
