...
export class TableOfPointRow{
	...
	//Player (websocket) | _numOfMatch  |   stars  |  _numberOfVictories | _pointsBalance | _pointsMade |

	constructor (webSocketUserSession: WebSocketUserSession){
